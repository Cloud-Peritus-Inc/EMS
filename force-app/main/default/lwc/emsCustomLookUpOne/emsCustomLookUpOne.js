...
import lookUp from '@salesforce/apex/managerSeeEmployeeRec.serchUser';
import user_Id from '@salesforce/user/Id';


export default class EmsCustomLookUpOne extends LightningElement {
    ...
    @track inputClass = '';
    @wire(lookUp, {userId : '$user_Id'})
    wiredRecords({ error, data }) {console.log('User ID'+user_Id);
