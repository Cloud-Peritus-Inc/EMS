...
export default class EMS_LM_LeaveBalance extends LightningElement {
  ...
  @track annualLeaveContent = 'Annual leave (also known as Paid time-off) permits an employee to take time off from work for personal reasons. Every quarter, 5 Annual leaves get credited to the leave balance.';
