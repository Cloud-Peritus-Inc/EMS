  ...
  connectedCallback() {
    ...
    getUserContactInfo({ userId: this.userId }).then(result => {
      ...
      if (employye != null) {
        ...
        this.countryvalpa = employye.PA_Country__c;
        this.countryval = employye.CA_Country__c;
 ...
 */
  ...
  SaveSubmitcontact(event) {
    ...
    contactObj.PA_Country__c = this.countryvalpa;
    contactObj.CA_Country__c = this.countryval;
