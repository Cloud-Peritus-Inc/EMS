...
saturdayVal1 = false;
    ...
    timesheetRecordsData({ data, error }) {
        if (data) {
            ...
            console.log('Result ==> ' +JSON.stringify(this.resultRecords)); 
            ...
            this.WFHMonday=this.resultRecords[0].WFHMonday;
            this.WFHTuesday=this.resultRecords[0].WFHTuesday;
            this.WFHWednesday=this.resultRecords[0].WFHWednesday;
            this.WFHThursday=this.resultRecords[0].WFHThursday;
            this.WFHFriday=this.resultRecords[0].WFHFriday;
            this.WFHSaturday=this.resultRecords[0].WFHSaturday;
            this.WFHSunday=this.resultRecords[0].WFHSunday;
            console.log('this.resultRecords[0].WFHFriday' ,this.resultRecords[0].WFHFriday);
